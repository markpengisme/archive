...
public class TestUtil {
    ...
    public static void insertFakeData(SQLiteDatabase db){
        ...
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 1);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_GENDER, 0);
        list.add(cv);

        cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, "Tim");
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 2);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_GENDER, 1);
        list.add(cv);

        cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, "Jessica");
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 3);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_GENDER, 0);
        list.add(cv);

        cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, "Larry");
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 4);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_GENDER, 1);
        list.add(cv);

        cv = new ContentValues();
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, "Kim");
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_AGE, 5);
        cv.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_GENDER, 0);
        list.add(cv);
